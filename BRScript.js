...
const images = [
    'images/gosling-sad-gosling.gif',
    'images/good-mood-gosling.gif',
    'images/gosling3.gif',
    'images/sandy-gosling.gif',
    'images/gosling1.gif'
];

const audios = [
    'audio/lonely.mp3',
    'audio/Tears In The Rain.mp3',
    'audio/Elvis - falling in love.mp3',
    'audio/Joi.mp3',
    'audio/Frank_Sinatra-Summer_Wind.mp3'
];
